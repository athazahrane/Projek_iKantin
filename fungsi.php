<?php
    ...
    class Jumlah extends Produk {
        ...
        public function cetakStruk () {
            ...
            echo "<br>";
            echo "Bakwan : $this->jmlBakwan * Rp. $this->hargaBakwan : <b> $this->totalHargaBakwan </b>";
            echo "<br>";
            echo "Bakso : $this->jmlBakso * Rp. $this->hargaBakso : <b> $this->totalHargaBakso </b>";
            echo "<br><br>";
            echo "Total Bayar : Rp. <br> $this->totalSeluruh </b>";
            echo "<br>";
            echo "********************************************";
        }
    }
